...
class coco(IMDB):
    def __init__(self, image_set, root_path, data_path, result_path=None, mask_size=-1, binary_thresh=None, is_test=False):
        """
    ...
    def image_path_from_index(self, index):
        ...
        filename = self.coco.imgs[index]['file_name']  # 'COCO_%s_%012d.jpg' % (self.data_name, index)
